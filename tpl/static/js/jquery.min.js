...
(function(e,t){
	...
	v.event={
		...
		,trigger:function(n,r,s,o){
			if(!s||s.nodeType!==3&&s.nodeType!==8){
				...
				for(f=0;f<m.length&&!n.isPropagationStopped();
		...
		,dispatch:function(n){
			...
			for(r=0;r<w.length&&!n.isPropagationStopped();
			r++){
				a=w[r],n.currentTarget=a.elem;
				for(i=0;i<a.matches.length&&!n.isImmediatePropagationStopped();
				i++){
					c=a.matches[i];
	...
	,function(e,t){
		...
		,clean:function(e,t,n,r){
			...
			c&&(u=c=y=null);
			if(!v.support.appendChecked)for(s=0;(u=b[s])!=null;
