...
$(function() {
	$.fn.manhuaDate = function(options) {
        ...
        //关闭
        	$("#calenderclose").live("click",function(){
        	   $(".calender").hide();
        	});
		//当鼠标离开控件上面的时候延迟3秒关闭
        ...
        $(".calender").live("mouseover",function(){ clearTimeout(stc);});
		//当鼠标移到控件上面的时候显示
