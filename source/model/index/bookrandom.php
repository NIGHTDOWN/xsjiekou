...
class bookrandom extends Y
{
    ...
    public function getcartoon($cityid, $size = 8)
    {
        ...
        $list = T('cartoon')->set_global_where([ 'lang' => $cityid])->field('cartoon_id,bpic_dsl,other_name,`desc`,bpic,writer_name,isfree,update_status,2 as type')
