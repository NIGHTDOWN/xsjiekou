...
class cart_aikan extends Clibase
{
    ...
    public function getbookdetail($remotebookid)
    {
        ...
        $api = "/api/cartoon/get_cartoonDetail";
        $id = $remotebookid;
    ...
    {
        $api = "/api/cartoon/get_cart_section";
        $data = ["cartoon_id" => $id];
        //远程与本地字段对应
        ...
        //更新字数
        //更新状态
        list($s, $data) = $this->getdata($datas, ['code', 'result.list']);
        if ($data) {
    ...
    public function getremoc($remote_book_id, $remote_sec_id, $remote_sec_num)
    {
        ...
        $api = "/api/cartoon/get_wap_content";
        $bid = $remote_book_id;
        $sid = $remote_sec_id;
        $data = [
            // "token" => $this->token,
        ...
        list($s, $data) = $this->getdata($datas, ['code', 'result.cart_sec_contents']);
        // d($data, 1);
        if ($data) {
            return ($data);
